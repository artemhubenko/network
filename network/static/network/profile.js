...
function load() {
    ...
    const username = profilePage.dataset.profile;

    fetch(`/api/posts?offset=${start}&limit=${quantity}&username=${username}`)
...
function add_post(post) {
    ...
    document.querySelector("#user-posts").append(post_card);
